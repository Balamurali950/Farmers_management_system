...
local_server= True
app = Flask(__name__)
new_secret_key = secrets.token_hex(16)  # Generate a 32-character (16 bytes) hexadecimal key
...
def triggers():
    ...
    per_page = 10
    triggers = Trig.query.order_by(Trig.timestamp.desc()).paginate(page=page, per_page=per_page)
